...
Route::get('register', [UserAuthController::class, 'register'])->name('auth.reg');

//Route::get('register', [UserAuthController::class, 'register'])->name('auth.reg')->middleware('AlreadyLoggedIn');

Route::post('create', [UserAuthController::class, 'create'])->name('auth.create');

Route::post('check', [UserAuthController::class, 'check'])->name('auth.check');

Route::get('welcome', [UserAuthController::class, 'welcome'])->name('isLoggedIn');
